...
INSERT INTO tbl_usuario (USUARIO,CLAVE,NOMBRE)
VALUES('ADMIN','$2a$10$i0Vvxq8fK0x5rxrtHvq6duO1.9AX6J/O23cM9D09aqKUzzpP1kOO2','ADMINISTRADOR');
 INSERT INTO tbl_usuario(USUARIO,CLAVE,NOMBRE)
VALUES('DEMO','$2a$10$i0Vvxq8fK0x5rxrtHvq6duO1.9AX6J/O23cM9D09aqKUzzpP1kOO2','DEMO');

SELECT ID_USUARIO ,USUARIO,CLAVE,NOMBRE FROM tbl_usuario;
...
SELECT AUTHORITY_ID,NOMBRE FROM tbl_authority;

INSERT INTO tbl_usuario_authority (ID_USUARIO,AUTHORITY_ID)
VALUES(1,1);
INSERT INTO tbl_usuario_authority(ID_USUARIO,AUTHORITY_ID)
VALUES(1,2);
INSERT INTO tbl_usuario_authority(ID_USUARIO,AUTHORITY_ID)
...
SELECT USUARIO_AUTHORITY_ID,ID_USUARIO,AUTHORITY_ID FROM tbl_usuario_authority;
